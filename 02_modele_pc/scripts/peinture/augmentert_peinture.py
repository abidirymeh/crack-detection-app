# augmenter_et_tester_peinture.py
import cv2
import numpy as np
...
# 6. Résultats pour différents seuils
print("\n" + "=" * 60)
...
# 7. Comparaison avec images originales seules
print("\n" + "=" * 60)
